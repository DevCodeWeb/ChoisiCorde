...
export const HeadView = () => {
  ...
  return (
    <section className="relative w-screen">
      ...
      />
      <div className="flex flex-col col-span-5 sm:text-center sm:col-span-12  md:text-center md:col-span-12 pt-[250px] sm:pt-0 md:pt-0">
      ...
      <div className="h-full col-span-6 col-start-7">
        <img
          src="assets/HeadView.jpg"
          alt="Cordiste"
